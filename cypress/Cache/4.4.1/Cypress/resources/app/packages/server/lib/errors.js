(function() {
  var AU, Promise, _, ansi_up, chalk, clone, displayFlags, displayRetriesRemaining, get, getMsgByType, isCypressErr, isProduction, listItems, log, logException, strip, throwErr, trimMultipleNewLines, twoOrMoreNewLinesRe, warnIfExplicitCiBuildId, warning,
  ...
  displayRetriesRemaining = function(tries) {
    var lastTryNewLine, times;
    times = tries === 1 ? 'time' : 'times';
    lastTryNewLine = tries === 1 ? "\n" : "";
  ...
  getMsgByType = function(type, arg1, arg2, arg3) {
    var err, filePath, msg, str;
    if (arg1 == null) {
      arg1 = {};
    }
    switch (type) {
      ...
      case "BROWSER_NOT_FOUND_BY_PATH":
        msg = "We could not identify a known browser at the path you provided: `" + arg1 + "`\n\nThe output from the command we ran was:";
        return {
          msg: msg,
          details: arg2
        };
      ...
      case "DASHBOARD_UNKNOWN_CREATE_RUN_WARNING":
        return "Warning from Cypress Dashboard: " + arg1.message + "\n\nDetails:\n" + (JSON.stringify(arg1.props, null, 2));
      ...
      case "RECORD_PARAMS_WITHOUT_RECORDING":
        return "You passed the --ci-build-id, --group, --tag, or --parallel flag without also passing the --record flag.\n\n" + (displayFlags(arg1, {
      ...
      case "ERROR_READING_FILE":
        filePath = "`" + arg1 + "`";
        err = "`" + arg2 + "`";
        return "Error reading from: " + (chalk.blue(filePath)) + "\n\n" + (chalk.yellow(err));
      case "ERROR_WRITING_FILE":
        filePath = "`" + arg1 + "`";
        err = "`" + arg2 + "`";
        return "Error writing to: " + (chalk.blue(filePath)) + "\n\n" + (chalk.yellow(err));
      case "NO_SPECS_FOUND":
        if (!arg2) {
      ...
      case "PLUGINS_DIDNT_EXPORT_FUNCTION":
        msg = "The `pluginsFile` must export a function.\n\nWe loaded the `pluginsFile` from: `" + arg1 + "`\n\nIt exported:";
        return {
          msg: msg,
          details: JSON.stringify(arg2)
        };
      case "PLUGINS_FUNCTION_ERROR":
        msg = ("The function exported by the plugins file threw an error.\n\nWe invoked the function exported by `" + arg1 + "`, but it threw an error.").trim();
        return {
          msg: msg,
          details: arg2
        };
      case "PLUGINS_UNEXPECTED_ERROR":
        msg = ("The following error was thrown by a plugin. We stopped running your tests because a plugin crashed. Please check your plugins file (`" + arg1 + "`)").trim();
        return {
          msg: msg,
          details: arg2
        };
      case "PLUGINS_VALIDATION_ERROR":
        msg = ("The following validation error was thrown by your plugins file (`" + arg1 + "`).").trim();
        return {
          msg: msg,
          details: arg2
        };
      ...
      case "SETTINGS_VALIDATION_ERROR":
        filePath = "`" + arg1 + "`";
        return "We found an invalid value in the file: " + (chalk.blue(filePath)) + "\n\n" + (chalk.yellow(arg2));
      case "PLUGINS_CONFIG_VALIDATION_ERROR":
        filePath = "`" + arg1 + "`";
        return "An invalid configuration value returned from the plugins file: " + (chalk.blue(filePath)) + "\n\n" + (chalk.yellow(arg2));
      ...
      case "PAID_PLAN_EXCEEDS_MONTHLY_PRIVATE_TESTS":
        return "You've exceeded the limit of private test recordings under your current billing plan this month. " + arg1.usedTestsMessage + "\n\nTo upgrade your account, please visit your billing to upgrade to another billing plan.\n\n" + arg1.link;
      case "FREE_PLAN_EXCEEDS_MONTHLY_TESTS":
        return "You've exceeded the limit of test recordings under your free plan this month. " + arg1.usedTestsMessage + "\n\nTo continue recording tests this month you must upgrade your account. Please visit your billing to upgrade to another billing plan.\n\n" + arg1.link;
      case "FREE_PLAN_IN_GRACE_PERIOD_EXCEEDS_MONTHLY_TESTS":
        return "You've exceeded the limit of test recordings under your free plan this month. " + arg1.usedTestsMessage + "\n\nYour plan is now in a grace period, which means your tests will still be recorded until " + arg1.gracePeriodMessage + ". Please upgrade your plan to continue recording tests on the Cypress Dashboard in the future.\n\n" + arg1.link;
      case "PAID_PLAN_EXCEEDS_MONTHLY_TESTS":
        return "You've exceeded the limit of test recordings under your current billing plan this month. " + arg1.usedTestsMessage + "\n\nTo upgrade your account, please visit your billing to upgrade to another billing plan.\n\n" + arg1.link;
      ...
      case "FIXTURE_NOT_FOUND":
        return "A fixture file could not be found at any of the following paths:\n\n > " + arg1 + "\n > " + arg1 + "{{extension}}\n\nCypress looked for these file extensions at the provided path:\n\n > " + (arg2.join(', ')) + "\n\nProvide a path to an existing fixture file.";
      case "AUTH_COULD_NOT_LAUNCH_BROWSER":
        return "Cypress was unable to open your installed browser. To continue logging in, please open this URL in your web browser:\n\n```\n" + arg1 + "\n```";
      case "AUTH_BROWSER_LAUNCHED":
        return "Check your browser to continue logging in.";
      case "BAD_POLICY_WARNING":
        return "Cypress detected policy settings on your computer that may cause issues.\n\nThe following policies were detected that may prevent Cypress from automating Chrome:\n\n > " + (arg1.join('\n > ')) + "\n\nFor more information, see https://on.cypress.io/bad-browser-policy";
  ...
  throwErr = function(type, arg1, arg2, arg3) {
  ...
  logException = Promise.method(function(err) {
