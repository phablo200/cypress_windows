(function() {
  var CacheBuster, Promise, SPEC_URL_PREFIX, _, cwd, escapeFilenameInUrl, glob, path, pathHelpers, specsUtil;
    ...
    handleIframe: function(req, res, config, getRemoteState) {
      ...
      return this.getSpecs(test, config).then((function(_this) {
        return function(specs) {
          specs = specs.map(function(fileName) {
