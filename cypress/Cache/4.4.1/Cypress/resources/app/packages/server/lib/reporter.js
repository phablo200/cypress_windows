(function() {
  var Mocha, Promise, Reporter, STATS, _, createRunnable, createSuite, debug, events, getParentTitle, mergeErr, mergeRunnable, mochaErrMsgExtractionRe, mochaReporters, path, reporters, safelyMergeRunnable, setDate,
    slice = [].slice;
  ...
  mergeErr = function(runnable, runnables, stats) {
    var message, originalMatch, test;
