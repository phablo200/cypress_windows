(function() {
  var EE, Promise, _, appData, baseEmitter, clientSideError, cwd, debug, errorMessage, fileObjects, fileProcessors, getOutputPath, path, plugins, resolve, savedState, setDefaultPreprocessor;
